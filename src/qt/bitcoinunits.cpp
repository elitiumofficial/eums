...
QString BitcoinUnits::id(int unit)
{
    ...
    case EUMS:
        return QString("eums");
    case mPIE:
        return QString("meums");
    case uPIE:
        return QString::fromUtf8("ueums");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case EUMS:
            return QString("EUMS");
        case mPIE:
            return QString("Milli-EUMS (1 / 1" THIN_SP_UTF8 "000)");
        case uPIE:
            return QString("Micro-EUMS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
