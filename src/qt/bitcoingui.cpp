                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("eums Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a eums address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and eums: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About eums Core"), this);
    aboutAction->setStatusTip(tr("Show information about eums Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for eums"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your eums addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified eums addresses"));
    ...
    openAction->setStatusTip(tr("Open a eums: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the eums Core help message to get a list with possible eums command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("eums Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to eums network", "", count));
}
...
{
    QString strTitle = tr("eums Core"); // default title
