...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* eums features */
        {"eums", "masternode", &masternode, true, true, false},
        {"eums", "masternodelist", &masternodelist, true, true, false},
        {"eums", "mnbudget", &mnbudget, true, true, false},
        {"eums", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"eums", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eums", "mnsync", &mnsync, true, true, false},
        {"eums", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"eums", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use eumsd, or the -server option to eums-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> eums-cli " + methodname + " " + args + "\n";
}
