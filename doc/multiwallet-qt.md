...
In order to support loading of multiple wallets in eums-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eums.cpp.
...
Changes to eums.cpp
----------------------
eums.cpp is the entry point into eums-qt, and as such, will require some minor modifications to provide hooks for
