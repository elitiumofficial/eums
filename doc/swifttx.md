...
This mechanism has been integrated into Bitcore-Node-eums which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eums-Project/insight-api-eums#web-socket-api](https://github.com/eums-Project/insight-api-eums#web-socket-api) 
* API: [https://github.com/eums-Project/insight-api-eums#swifttx-transactions](https://github.com/eums-Project/insight-api-eums#swifttx-transactions) 
...
By default, the eums Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the eums Core daemon:
