...
RESOURCES += src/qt/eums.qrc src/qt/eums_locale.qrc

TRANSLATIONS += src/qt/locale/eums_bg.ts \
                src/qt/locale/eums_de.ts \
                src/qt/locale/eums_en.ts \
                src/qt/locale/eums_es.ts \
                src/qt/locale/eums_fi.ts \
                src/qt/locale/eums_fr.ts \
                src/qt/locale/eums_it.ts \
                src/qt/locale/eums_ja.ts \
                src/qt/locale/eums_pl.ts \
                src/qt/locale/eums_pt.ts \
                src/qt/locale/eums_ru.ts \
                src/qt/locale/eums_sk.ts \
                src/qt/locale/eums_sv.ts \
                src/qt/locale/eums_vi.ts \
                src/qt/locale/eums_zh_CN.ts \
                src/qt/locale/eums_zh_TW.ts
