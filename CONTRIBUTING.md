Contributing to eums Core
============================

The eums Core project operates an open contributor model where anyone is
...
The following applies to code changes to the eums Core project, and is not to be
confused with overall eums Network Protocol consensus changes.

Whether a pull request is merged into eums Core rests with the project merge
...
Patches that change eums consensus rules are considerably more involved than
...
Where a patch set proposes to change the eums consensus, it must have been
...
The project leader is the release manager for each eums Core release.
